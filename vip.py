...
def mostrar_admin_vip(bot, chat_id):
    ...
    kb.row(
        types.InlineKeyboardButton("💳 Pagamento Online", callback_data="vip_cfg_online")
    )
    kb.row(
    ...
    online = "🟢 ATIVO" if cfg("vip_pagamento_online", "1") == "1" else "🔴 DESATIVADO"
