...
def start(message):
    ...
    # DIAGNOSTICO DO LINK DO BOTAO
    link_diagnostico = "https://t.me/PITBULLPRIME1"

    print("========== LINK DO BOTAO ==========")
    print(f"LINK: {link_diagnostico}")

    markup.add(
        types.InlineKeyboardButton(
            "👥 Entrar no Grupo",
            url=link_diagnostico
        )
    )
...
🔗 <b>LINK DIRETO PARA TESTE:</b>
https://t.me/PITBULLPRIME1
""",
        reply_markup=markup,
        parse_mode="HTML"
    )
